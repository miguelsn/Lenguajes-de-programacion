...
;; condiciones de error
(test/exn (eval `(or 1 2)) "Argumento incorrecto")

(test/exn (eval `(or false 2)) "Argumento incorrecto")

(test (eval `(or true 2)) (boolV #t))

(test/exn (eval `(and "foo" "bar")) "Argumento incorrecto")

(test/exn (eval `(and true "bar")) "Argumento incorrecto")
...
;; condiciones de error
(test/exn (eval `((+ 1 2) 3)) "Call invalido")
